...
export default function SuperAdminUsuariosPage() {
  ...
  const formatFechaRelativa = (fecha: string | null | undefined) => {
    ...
    return fecha_obj.toLocaleDateString("es-PE", {
      year: "numeric",
      month: "short",
      day: "numeric",
    });
  ...
  const puedeEliminar = (
    ...
    if (!usuarioActual)
      return { puede: false, razon: "Cargando información..." };
    ...
    if (esOtroAdmin) {
      return {
        puede: false,
        razon: "No puedes eliminar a otros administradores",
      };
    }
  ...
  if (loading) {
    return <div className="p-4 md:p-8">Cargando usuarios...</div>;
  }
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {usuarios.map((usuario) => (
              <tr key={usuario.id}>
                ...
                <td className="px-3 md:px-6 py-2 md:py-4 whitespace-nowrap">
                  <div className="flex flex-wrap gap-0.5 md:gap-1">
                    {usuario.roles.map((rol, idx) => (
                      <span
                        key={idx}
                        className="px-1.5 md:px-2 py-0.5 md:py-1 text-xs bg-blue-100 text-blue-800 rounded"
                      >
                        {rol}
                      </span>
                    ))}
                ...
                <td className="px-3 md:px-6 py-2 md:py-4 whitespace-nowrap text-xs md:text-sm text-gray-600">
                  <span className="text-xs bg-gray-100 px-1.5 md:px-2 py-0.5 md:py-1 rounded">
                ...
                <td className="px-3 md:px-6 py-2 md:py-4 whitespace-nowrap text-xs md:text-sm">
                  <div className="flex flex-col md:flex-row gap-1 md:gap-2">
                    <button
                      ...
                      className="inline-flex items-center gap-1 text-blue-600 hover:text-blue-800 hover:bg-blue-50 px-1.5 md:px-2 py-0.5 md:py-1 rounded text-xs md:text-sm"
          ...
          <div className="bg-white rounded-lg p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <p className="text-sm text-blue-800">
                ...
                <span
                  className={
                    editando.activo ? "text-green-600" : "text-red-600"
                  }
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 border-t pt-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, direccion1: e.target.value })
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          ...
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <p className="text-sm text-gray-700">
                Selecciona los roles que tendrá este usuario. Estos permisos
                determinan qué acciones puede realizar en el sistema.
              </p>
            </div>
              ...
              <button
                onClick={() => {
                  ...
                  const roleIds = Array.from(checkboxes).map((cb) =>
                    Number.parseInt(
                      (cb as HTMLInputElement).getAttribute("data-rol-id") ||
                        "0"
                    )
                  );
          ...
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            <div className="mb-6">
              ...
              <p className="text-gray-600 text-sm">
                ...
                la cuenta del usuario {usuarioAEliminar.nombres}{" "}
                {usuarioAEliminar.apellidoPaterno}
              </p>
            </div>
            ...
            <div className="mb-6">
              <label className="block text-sm font-semibold text-gray-700 mb-2">
                Confirma escribiendo el usuario:{" "}
            ...
            <div className="flex gap-4">
              <button
                ...
                disabled={
                  loadingAction ||
                  confirmacionEliminar !== `@${usuarioAEliminar.user}`
                }
